...
algorithms <- list("UBCF_N_C" = list(name="UBCF", param=list(normalize = NULL, method="Cosine")),
                   ...
                   "UBCF_C_E" = list(name="UBCF", param=list(normalize = "center", method="Euclidean")),
                   "UBCF_Z_E" = list(name="UBCF", param=list(normalize = "Z-score", method="Euclidean")),
                   "UBCF_N_J" = list(name="UBCF", param=list(normalize = NULL, method="Jaccard")),
                   "UBCF_C_J" = list(name="UBCF", param=list(normalize = "center", method="Jaccard")),
                   "UBCF_Z_J" = list(name="UBCF", param=list(normalize = "Z-score", method="Jaccard")),
                   "UBCF_N_C_5" = list(name="UBCF", param=list(normalize = NULL, method="Cosine", nn=5)),
